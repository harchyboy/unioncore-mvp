        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div class="flex items-center justify-between">
            <div>
              ...
              <div class="flex items-center mt-2">
                <i
                  class="fa-solid fa-arrow-down text-green-600 text-sm mr-1"
                ></i>
                <span class="text-sm text-green-600 font-medium"
                  >-0.5d faster</span
                >
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div class="flex items-center justify-between">
            <div>
              ...
              <div class="flex items-center mt-2">
                <i
                  class="fa-solid fa-exclamation-triangle text-red-600 text-sm mr-1"
                ></i>
                <span class="text-sm text-red-600 font-medium"
            ...
            <div class="bg-red-100 p-4 rounded-full">
              <i
                class="fa-solid fa-exclamation-circle text-red-600 text-2xl"
              ></i>
            </div>
          </div>
        </div>
    ...
    <section class="mb-8" id="approval-analytics-section">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-semibold text-gray-900">
              Approvals by Role Distribution
            </h3>
            <button
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h4 class="font-semibold text-gray-900">
                  HoT Approval Workflow
                </h4>
                <p class="text-sm text-gray-500">
                  Standard process for Heads of Terms
                </p>
              </div>
            </div>
            <div class="space-y-3">
              <div class="flex items-center space-x-2">
                <div
                  class="w-8 h-8 bg-green-500 text-white rounded-full flex items-center justify-center text-xs font-bold"
                >
              ...
              <div class="flex items-center space-x-2">
                <div
                  class="w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs font-bold"
                >
                  2
                </div>
                <div class="flex-1">
                  ...
                  <p class="text-xs text-gray-500">
                    Rachel Green - In Progress
                  </p>
                </div>
              </div>
              <div class="flex items-center space-x-2">
                <div
                  class="w-8 h-8 bg-gray-300 text-white rounded-full flex items-center justify-center text-xs font-bold"
                >
                  3
                </div>
                <div class="flex-1">
          ...
          <div class="p-5 bg-orange-50 border border-orange-200 rounded-lg">
            ...
            <div class="space-y-3">
              ...
              <div class="flex items-center space-x-2">
                <div
                  class="w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center text-xs font-bold"
                >
                  2
                </div>
                <div class="flex-1">
        ...
        <div class="space-y-6">
            ...
            <div class="flex-1">
              <div class="flex items-center space-x-2">
                ...
                <span class="text-blue-600 font-medium"
                  >Financial Model v1.8</span
                >
              </div>
              <p class="text-sm text-gray-500 mt-1">
                Bermondsey Industrial Unit • 1 hour ago
              </p>
            </div>
            ...
            <div class="flex-1">
              <div class="flex items-center space-x-2">
                ...
                <span class="text-red-600 font-medium"
                  >Contract Amendment v2.1</span
                >
              </div>
              <p class="text-sm text-gray-500 mt-1">
                Westminster Office Space • 2 hours ago
              </p>
              <p class="text-sm text-red-600 mt-1">
                Reason: Terms need revision for compliance
              </p>
            </div>
            <div class="text-right">
              <span
            ...
            <div class="flex-1">
              <div class="flex items-center space-x-2">
                ...
                <span class="text-orange-600 font-medium"
                  >Property Survey Report</span
                >
              </div>
              <p class="text-sm text-gray-500 mt-1">
                Camden Market Complex • 3 hours ago
              </p>
            </div>
            <div class="text-right">
              <span
          ...
          <div class="flex items-start space-x-4">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-gray-500 mt-1">
                Hackney Creative Hub • 4 hours ago
              </p>
            </div>
            <div class="text-right">
              <span
...
(function () {
  ...
  const APPROVAL_REQUESTS_DATA = [
    {
      ...
      description:
        "Updated financial projections for Bermondsey Industrial Unit with revised rental income assumptions",
    ...
    },
    {
      ...
      description:
        "Lease extension terms for Westminster Office Space - 5 year extension with break clause",
      category: "Contract",
    ...
    },
    {
      ...
      description:
        "Structural assessment and condition report for Camden Market Complex acquisition",
      category: "Report",
    ...
    },
    {
      ...
      description:
        "Heads of Terms for Hackney Creative Hub - co-working space conversion",
      category: "HoT",
    ...
    },
    {
      ...
      description:
        "HVAC system upgrade for Shoreditch Tech Campus - energy efficiency improvements",
      category: "Financial",
    ...
    },
    {
      ...
      description:
        "New tenant contract for Canary Wharf Retail Unit - premium fashion retailer",
      category: "Contract",
    ...
    },
    {
      ...
      description:
        "Comprehensive risk analysis for Stratford Residential Development project",
      category: "Report",
    ...
    },
    {
      ...
      description:
        "Q4 marketing spend allocation for portfolio-wide promotional campaigns",
      category: "Financial",
    ...
    },
    {
      ...
      description:
        "Annual property insurance renewal for entire portfolio with updated valuations",
      category: "Contract",
    ...
    },
    {
      ...
      description:
        "Fire safety and building regulations compliance for Greenwich Office Park",
      category: "Report",
    ...
    },
    {
      ...
      description:
        "Investment proposal for waterfront mixed-use development in Docklands area",
      category: "HoT",
    ...
    },
    {
      ...
      description:
        "Interior refurbishment budget for Kensington Luxury Apartments lobby upgrade",
      category: "Financial",
    ...
    },
    {
      ...
      description:
        "3-year security services contract for Mayfair Commercial Building",
      category: "Contract",
    ...
    },
    {
      ...
      description:
        "ESG compliance assessment for Southwark Sustainable Housing development",
      category: "Report",
    ...
    },
    {
      ...
      description:
        "Market rent review and adjustment proposal for Notting Hill Retail Portfolio",
      category: "Financial",
    ...
    },
    {
      ...
      description:
        "Change of use application for Brixton Mixed Use Building - retail to residential",
      category: "Report",
    ...
    },
    {
      ...
      description:
        "Network and server infrastructure upgrade for Croydon Business Park",
      category: "Financial",
  ...
  function createApprovalCard(approval) {
    ...
    card.className =
      "bg-white border border-gray-200 rounded-lg p-5 hover:shadow-md transition-shadow";
    card.setAttribute("data-approval-id", approval.id);

    const priorityConfig =
      PRIORITY_CONFIG[approval.priority] || PRIORITY_CONFIG.medium;
    const categoryConfig = CATEGORY_CONFIG[approval.category] || {
      icon: "fa-file",
      color: "text-gray-600",
      bg: "bg-gray-100",
    };
  ...
  function handleApprove(approval, card) {
    ...
    if (
      confirm(`Approve "${approval.title}"?\n\nThis action cannot be undone.`)
    ) {
      showNotification(
        "Approval Confirmed",
  ...
  function handleEscalate(approval, card) {
    ...
    if (
      confirm(
        `Escalate "${approval.title}" to senior management?\n\nThis will notify the next level approver.`
      )
    ) {
      showNotification(
        "Request Escalated",
      ...
      if (priorityBadge) {
        priorityBadge.className =
          "inline-flex items-center px-2 py-1 rounded-full text-xs font-bold bg-orange-100 text-orange-800 border border-orange-200";
        priorityBadge.innerHTML =
          '<i class="fa-solid fa-arrow-up mr-1"></i>ESCALATED';
      }
    }
  }
  ...
  function handleStaticEscalate(button) {
    ...
    if (
      confirm(
        `Escalate "${title}" to senior management?\n\nThis will notify the next level approver.`
      )
    ) {
      showNotification(
        "Request Escalated",
  ...
  function handleStaticReview(button) {
    ...
    showNotification("Review Mode", `Opening review form for ${title}`, "info");
  }
...
(function () {
        ...
        series: {
          ...
          point: {
            events: {
              click: function () {
                console.log(
                  `📈 Clicked: ${this.series.name} - ${this.category}`
                );
                showNotification(
                  "Filter Applied",
  ...
  function updateTimelineInsights(data) {
    const insightsContainer = document
      .querySelector("#approval-timeline-chart")
      .closest(".bg-white")
      .querySelector(".grid");
  ...
  function updateRoleStats(data) {
    const statsContainer = document
      .querySelector("#approval-role-chart")
      .closest(".bg-white")
