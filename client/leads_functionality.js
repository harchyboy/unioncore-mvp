...
function showLeadDetail(leadId) {
    ...
    // Get BANT scores
    const bantScores = leadCard.querySelectorAll('.text-sm.font-semibold.text-slate');
    ...
    // Get details
    const details = leadCard.querySelectorAll('.flex.items-center.space-x-4 span');
    ...
    document.getElementById('leadDetailAuthorityScore').textContent = authorityScore;
    document.getElementById('leadDetailNeedScore').textContent = needScore;
    document.getElementById('leadDetailTimelineScore').textContent = timelineScore;
    
    document.getElementById('leadDetailBudgetValue').textContent = budgetValue + ' confirmed';
    document.getElementById('leadDetailAuthorityLevel').textContent = authorityLevel;
    document.getElementById('leadDetailNeedLevel').textContent = needLevel + ' need';
    document.getElementById('leadDetailTimelineValue').textContent = timelineValue;
    ...
    document.getElementById('leadDetailScore').className = `text-4xl font-bold ${colors.text}`;
