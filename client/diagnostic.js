...
function runPropertyIndexDiagnostic() {
  ...
  console.log(
    "   Page visible:",
    propertyIndexPage && !propertyIndexPage.classList.contains("hidden")
  );

  // Check data availability
  console.log(
    "2. Properties data available:",
  ...
  console.log(
    ...
    typeof initializePropertyIndex === "function"
  );
  console.log(
    "   debugInitialization:",
    typeof debugInitialization === "function"
  );
  console.log(
    "   resetPropertyIndex:",
    typeof resetPropertyIndex === "function"
  );
...
console.log(
  "🔧 Property Index Diagnostic loaded. Run runPropertyIndexDiagnostic() in console."
);
